...
class _AddEditNotePageState extends State<AddEditNotePage> {
    ...
    return Scaffold(
      ...
      body: Form(
          child: NoteFormWidget(
              ...
              onChangeTitle: (value) {setState(() {_title=value;});},
              onChangeDescription: (value) {setState(() {_description=value;});})),
    );
  }

  Widget _builderButtonSave() {
    return Padding(
  ...
  Future<void> _addNote() async {
    final note = Note(isImportant: _isImportant, number: _number, title: _title, description: _description, createdTime: DateTime.now(), id: null);
